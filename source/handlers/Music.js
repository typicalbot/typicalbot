...
module.exports = class {
    ...
    async stream(message, video, playlist = false) {
        ...
        if (connection.guildStream.queue.length >= (video.requester.guild.settings.music.queuelimit || 10)) return video.requester.error(`The queue limit of ${video.requester.guild.settings.music.queuelimit || 10} has been reached.`);
