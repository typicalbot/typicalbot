...
module.exports = class extends Command {
    ...
    execute(message, parameters, permissionLevel) {
        ...
        if (args[1]) {
            ...
            this.client.audioUtility.search(message.guild.settings, args[2]).then(results => {
                if (!results.length) return message.reply(`No results were found for the query **${args[2]}**.`);
