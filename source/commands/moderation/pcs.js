...
module.exports = class extends Command {
    ...
    async execute(message, parameters, permissionLevel) {
        ...
        if (action === "list") {
            ...
            if (reqPermissions < Constants.Permissions.Levels.SERVER_MEMBER) return message.error("You cannot use a permission level less than Server Member.");
            if (reqPermissions > Constants.Permissions.Levels.SERVER_OWNER) return message.error("You cannot use a permission level greater than Server Owner.");
