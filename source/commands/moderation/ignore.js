...
module.exports = class extends Command {
    ...
    execute(message, parameters, permissionLevel) {
        ...
        if (commands && message.guildSettings.ignored.commands.includes(message.channel.id)) return message.error("This channel is already ignoring commands.");
        if (invites && message.guildSettings.ignored.invites.includes(message.channel.id)) return message.error("This channel is already ignoring invites.");
