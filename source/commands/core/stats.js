...
module.exports = class extends Command {
    ...
    embedExecute(message, parameters, permissionLevel) {
        message.buildEmbed()
            ...
            .addField("» RAM (Used) on Shard", `${Math.round(100 * (process.memoryUsage().heapUsed / 1048576)) / 100}MB`, true)
            .addField("» RAM (Total) on Shard", `${Math.round(100 * (process.memoryUsage().heapTotal / 1048576)) / 100}MB`, true)
