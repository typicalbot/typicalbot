...
## [Unreleased]
### Changed
 - Contributor Guidelines to add requirement to update CHANGELOG in pull requests
 - Pull Request Template to add a confirmation that the CHANGELOG was updated
...
[Unreleased]: https://github.com/typicalbot/typicalbot/compare/2.5.0...HEAD
