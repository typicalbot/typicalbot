...
module.exports = class extends Command {
    ...
    async execute(message, parameters) {
        ...
        if (member) {
            if (actualUserPermissions.level < Constants.Permissions.Levels.SERVER_ADMINISTRATOR) { return message.error(this.client.functions.error('perms', { permission: Constants.Permissions.Levels.SERVER_ADMINISTRATOR }, actualUserPermissions)); }
