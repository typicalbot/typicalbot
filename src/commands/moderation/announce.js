...
module.exports = class extends Command {
    ...
    execute(message, parameters) {
        ...
        embed ?
            toChannel.buildEmbed(mentionRole ? mentionRole.toString() : "").setColor(0x00adff).setTitle(`Announcement`).setDescription(content).setFooter(message.author.tag, message.author.avatarURL() || null).send(`${mentionRole ? mentionRole.toString() : ""}`, { disableEveryone: false }) :
