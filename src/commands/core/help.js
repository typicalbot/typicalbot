...
module.exports = class extends Command {
    ...
    async execute(message, parameters) {
        if (!parameters) return message.send(`\u200B\t\tHello there, I'm TypicalBot! I was created by HyperCoder#2975 and nsylke#4490. If you would like to access my list of commands, try using \`${process.env.PREFIX}commands\`. If you need any help with commands or settings, you can find documentation at **<${Constants.Links.DOCUMENTATION}>**. If you cannot figure out how to use a command or setting, or would like to chat, you can join us in the TypicalBot Lounge at **<${Constants.Links.SERVER}>**.\n\n\t\t*Built upon over a year of experience, TypicalBot is the ironically-named bot that is far from typical. Stable, lightning fast, and easy to use, TypicalBot is there for you and will seamlessly help you moderate your server and offer some entertaining features for your users, every step of the way.*`);
    ...
    async embedExecute(message, parameters) {
        if (!parameters) {
            return message.buildEmbed()
                ...
                .setDescription(`\u200B\t\tHello there, I'm TypicalBot! I was created by HyperCoder#2975 and nsylke#4490. If you would like to access my list of commands, try using \`${process.env.PREFIX}commands\`. If you need any help with commands or settings, you can find documentation at **<${Constants.Links.DOCUMENTATION}>**. If you cannot figure out how to use a command or setting, or would like to chat, you can join us in the TypicalBot Lounge at **<${Constants.Links.SERVER}>**.\n\n\t\t*Built upon over a year of experience, TypicalBot is the ironically-named bot that is far from typical. Stable, lightning fast, and easy to use, TypicalBot is there for you and will seamlessly help you moderate your server and offer some entertaining features for your users, every step of the way.*`)
