...
module.exports = class extends Command {
    ...
    execute(message, response, permissionLevel) {
        ...
        const paged = this.client.functions.pagify(this.client.guilds.array().sort((a,b) => b.memberCount - a.memberCount).map(g => `${lengthen(`${g.name.replace(/[^a-z0-9 '"/\\\[\]()-_!@#$%^&*]/gmi, "")}`, 30)} : ${g.memberCount}`), page);
